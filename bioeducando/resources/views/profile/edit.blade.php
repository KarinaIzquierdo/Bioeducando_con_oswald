...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Inter', sans-serif; }
        ...
        .top-bar { height: 100px; background-color: #744d2d; display: flex; align-items: center; justify-content: flex-end; padding: 0 40px; }
        ...
        .alert { padding: 15px 20px; border-radius: 12px; margin-bottom: 25px; font-weight: 600; font-size: 0.95rem; transition: opacity 0.5s ease; }
...
<body>
    ...
    <div class="main-content">
        <div class="top-bar">
            <div style="background: white; padding: 5px; border-radius: 50%;">
                @if($user->avatar)
                    <img src="{{ asset('storage/' . $user->avatar) }}" alt="Perfil" style="border-radius: 50%; width: 50px; height: 50px; object-fit: cover;">
                @else
                    <img src="https://ui-avatars.com/api/?name={{ urlencode($user->name) }}&background=fff&color=744d2d&size=50" alt="Perfil" style="border-radius: 50%; width: 50px; height: 50px;">
                @endif
            </div>
        </div>
            ...
            <div class="profile-container">
                <div class="avatar-section card">
                    <div class="avatar-circle" onclick="document.getElementById('avatar-input').click()">
                        ...
                        @else
                            <i data-lucide="camera" size="40" id="camera-icon"></i>
                        @endif
                    </div>
                    <h3>{{ $user->name }}</h3>
    ...
    <script>
        ...
        // Auto-desvanecer alertas después de 3 segundos
