...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: "Inter", sans-serif; }
        body { background-color: #f4f7f4; min-height: 100vh; display: flex; overflow-x: hidden; }
        ...
        .main-content { flex: 1; margin-left: 260px; display: flex; flex-direction: column; min-height: 100vh; width: calc(100% - 260px); }
        .top-bar { height: 100px; background-color: #744d2d; display: flex; align-items: center; justify-content: space-between; padding: 0 40px; position: fixed; top: 0; left: 260px; width: calc(100% - 260px); z-index: 900; box-sizing: border-box; }
        ...
        .container { padding: 40px; flex: 1; margin-top: 100px; max-width: 800px; margin-left: auto; margin-right: auto; }
        ...
        .create-post-header .avatar-circle { width: 45px; height: 45px; background: #6ab06a; border-radius: 50%; display: flex; align-items: center; justify-content: center; color: white; font-weight: 700; flex-shrink: 0; overflow: hidden; }
        ...
        .avatar-circle { width: 50px; height: 50px; border-radius: 50%; display: flex; align-items: center; justify-content: center; color: white; font-weight: 700; overflow: hidden; }
        ...
        <div class="top-bar">
            ...
            <div class="profile-icon">
                @if(Auth::check() && Auth::user()->foto_path)
                    <img src="{{ asset(Auth::user()->foto_path) }}?v={{ time() }}" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
        ...
        <div class="container">
            ...
            <div class="create-post-card">
                <form action="{{ route("comunidad.publicar_user") }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="create-post-header">
                        <div class="avatar-circle" style="width: 45px; height: 45px; background: #6ab06a;">
            ...
            <div class="post-card">
                <div class="post-header">
                    <div class="avatar-circle" style="background: {{ ($post->user && $post->user->id % 2 == 0) ? "#6ab06a" : "#744d2d" }}; overflow: hidden;">
                        @if($post->user && $post->user->foto_path)<img src="{{ asset($post->user->foto_path) }}" alt="Avatar" style="width: 100%; height: 100%; object-fit: cover;">
                ...
                <div class="post-actions">
                    <button class="action-btn" onclick="toggleLike(this)"><i data-lucide="heart"></i> Me gusta</button>
                    ...
                    <div class="comments-list">
                        @forelse($post->comentarios as $comentario)
                            <div class="comment-item">
                                <div class="avatar-circle" style="width: 35px; height: 35px; font-size: 0.8rem; background: #6ab06a;">{{ substr($comentario->user->name ?? "U", 0, 1) }}</div>
