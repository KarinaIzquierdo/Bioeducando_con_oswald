...
<head>
    ...
    <title>Editar Proyecto PRAE - Admin</title>
...
<body>
    ...
    <div class="main-content">
        <div class="top-bar" style="width: 100%; box-sizing: border-box;">
            <h2><i data-lucide="book-open"></i> Editar Proyecto PRAE</h2>
        ...
        <div class="content-padding">
            <div class="form-card">
                <form action="{{ route('admin.prae.update', $proyecto->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="institucion" value="{{ $proyecto->institucion }}" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        @if($proyecto->imagen)
                            <img src="{{ asset('storage/' . $proyecto->imagen) }}" style="width: 100%; height: 200px; object-fit: cover; border-radius: 15px; margin-bottom: 10px;">
                        @endif
                        <input type="file" name="imagen" accept="image/*">
                    </div>
                    <div class="form-group">
                        <label>Documento PDF Actual</label>
                        @if($proyecto->archivo_pdf)
                            <p style="margin-bottom: 10px; color: #6ab06a;">Archivo cargado: {{ basename($proyecto->archivo_pdf) }}</p>
                        @endif
                        <input type="file" name="archivo_pdf" accept="application/pdf">
                    </div>
                    <button type="submit" class="btn-save">Actualizar Proyecto PRAE</button>
                </form>
            </div>
        </div>
    </div>
